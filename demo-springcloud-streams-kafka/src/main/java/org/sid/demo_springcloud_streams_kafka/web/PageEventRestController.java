package org.sid.demo_springcloud_streams_kafka.web;
...
import org.sid.demo_springcloud_streams_kafka.entities.PageEvent;
    ...
    public Flux<Map<String,Long>> analytics(){
        return Flux.interval(Duration.ofSeconds(1))
                .map(seq->{
                    ...
                    KeyValueIterator<Windowed<String>, Long> keyValueIterator = stats.fetchAll(from,now);
